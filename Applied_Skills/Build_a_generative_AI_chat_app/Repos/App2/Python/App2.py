...
chat_history = []
MAX_TURNS = # TODO: Limit the conversation history
...
def send_message(user_input: str):
    ...
    update_chat_history() # TODO: Task 3 - Add conversation history (part 1)
    ...
    update_chat_history()  # TODO: Task 3 - Add conversation history (part 2)
